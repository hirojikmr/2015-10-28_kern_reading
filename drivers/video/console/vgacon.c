...
static void vgacon_save_screen(struct vc_data *c)
{
	...
	if (!vga_bootup_console) {
		...
		c->vc_x = screen_info.orig_x; //HKMR
...
static int vgacon_scroll(struct vc_data *c, int t, int b, int dir,  //HKMR
			 int lines)
{
	unsigned long oldo;
	unsigned int delta;
...
const struct consw vga_con = { //HKMR
	.owner = THIS_MODULE,
